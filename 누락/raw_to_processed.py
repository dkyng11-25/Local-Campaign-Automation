...
def extract_hashtags(value) -> str | None:
    ...
    for token in tokens:
        ...
        if cleaned_tag:
            if cleaned_tag.casefold() == "#samsung" or cleaned_tag.casefold() == "#SAMSUNG" or cleaned_tag.casefold() == "#Samsung" or cleaned_tag.casefold() == "#삼성" or cleaned_tag.casefold() == "#삼성전자": 
                continue
